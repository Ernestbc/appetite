...
import guru.apps.llc.appetite.tasks.InitMoodsTask;
import guru.apps.llc.appetite.tasks.InitResultsTask;
import guru.apps.llc.appetite.tasks.InitSwingsTask;
