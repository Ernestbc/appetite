...
import guru.apps.llc.appetite.main.MainActivity;
import guru.apps.llc.appetite.tool.UserStorage;
...
public class SplashActivity extends Activity implements
    ...
    public void onConnected(Bundle bundle) {
        UserSession.sessionType = UserSession.SESSION_TYPE.GOOGLE_PLUS;
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        // Try to login via Appetite
            ...
            SharedPreferences pref = UserStorage.getPreferences();
            if(!pref.getBoolean(UserStorage.PREF_LOGGED_IN, false)) {
                UserSession.sessionType = UserSession.SESSION_TYPE.APPETITE;
    ...
    private void onSessionStateChange() {
        UserSession.sessionType = UserSession.SESSION_TYPE.FACEBOOK;
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
        finish();
    }
